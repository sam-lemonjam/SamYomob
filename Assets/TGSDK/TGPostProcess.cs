	...
	public static class TGPostProcess {
	    ...
	    public static void OnPostProcessBuild( BuildTarget buildTarget, string pathToBuiltProject ) {
			...
			if (buildTarget == BuildTarget.iPhone) {
				...
				string basePatch = "TGSDK/Plugins/1.8.2/iOS/";
                ...
                frameworkFiles.Add("frameworks/AppnextLib.framework");
                frameworkFiles.Add("frameworks/AppnextSDKCore.framework");
                ...
                frameworkFiles.Add("frameworks/PlayableAds.framework");
                ...
                frameworkFiles.Add("frameworks/ZZAdSDK.framework");
                frameworkFiles.Add("frameworks/ZZDWKit.framework");
                ...
                bundleFiles.Add("resources/UnityAds.bundle");
                bundleFiles.Add("resources/WMAdSDK.bundle");
                bundleFiles.Add("resources/ZplayMuteListener.bundle");
